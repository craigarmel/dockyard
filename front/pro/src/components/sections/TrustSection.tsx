...
const TrustSection: React.FC = () => (
    <section className="relative py-16 min-h-[450px] flex items-center justify-center overflow-hidden">
        ...
        <div
            ...
            aria-hidden="true"
        />
        <div className="relative z-10 w-full max-w-2xl md:max-w-3xl mx-auto bg-black/70 rounded-2xl shadow-2xl px-6 md:px-12 py-10 md:py-14 backdrop-blur-lg border border-white/10">
