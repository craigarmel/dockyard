        ...
        <div className="flex justify-between items-center">
          ...
          {/* Desktop Navigation */}
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link to="/trust" className="text-white hover:text-gray-200 transition-colors">
                Trust
              </Link>
              <Link to="/documentation" className="text-white hover:text-gray-200 transition-colors">
                Documentation
              </Link>
              ...
              <Link to='https://dockyard-fun.vercel.app/' className='bg-transparent px-6 py-2 rounded-lg text-white hover:text-black hover:bg-white border-2 border-white transition-colors transition'>
                Explore
              </Link>
            </div>
